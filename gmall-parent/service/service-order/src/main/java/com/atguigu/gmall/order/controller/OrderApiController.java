...
public class OrderApiController {
    ...
    public Result getOrderPageByUserId(@PathVariable Long page,
        ...
        IPage<OrderInfo> orderInfoIPage=this.orderService.getOrderPageByUserId(orderInfoPage,userId);
...
//                    验证库存
              ...
              CompletableFuture skuPriceComplatebleFuturn  =CompletableFuture.runAsync(()->{
                    //获取实时价格
        ...
        //保存订单
        Long orderId=this.orderService.submitOrder(orderInfo);
